...
|-------------+-----------------------------------------------|
| ~SPC m s c~ | find which functions are called by a function |
| ~SPC m s C~ | find where a function is called               |
| ~SPC m s d~ | find global definition of a symbol            |
| ~SPC m s e~ | search regular expression                     |
| ~SPC m s f~ | find a file                                   |
| ~SPC m s F~ | find which files include a file               |
| ~SPC m s I~ | create Cscope index                           |
| ~SPC m s r~ | find references of a symbol                   |
| ~SPC m s t~ | search text                                   |
